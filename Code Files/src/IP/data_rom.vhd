...
ARCHITECTURE SYN OF data_rom IS
	...
	SIGNAL sub_wire0	: STD_LOGIC_VECTOR (G_DATA_WIDTH-1 DOWNTO 0);

BEGIN
	q    <= sub_wire0(G_DATA_WIDTH-1 DOWNTO 0);
...
-- Retrieval info: PRIVATE: MIFfilename STRING "../src/IP/rom_data.mif"
...
-- Retrieval info: CONSTANT: INIT_FILE STRING "../src/IP/rom_data.mif"
